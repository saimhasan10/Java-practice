 ...
 * step 2: Compile (javac): comple the .java and create Byte code (.class) which
 * is machine readable
...
// Escape sequence - a special character followed by backslash. sometimes it is
// called as back-salash character
// example -> \b, \t, \n, \", \', \\